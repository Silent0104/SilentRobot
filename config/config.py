...
from motor.motor_asyncio import AsyncIOMotorClient as MongoClient
    ...
    SUPPORT_CHAT = getenv('SUPPORT_CHAT', "https://t.me/Silent_robo_11")
    SPAMWATCH_SUPPORT_CHAT = getenv('SPAMWATCH_SUPPORT_CHAT', "")
    SPAMWATCH_API = getenv('SPAMWATCH_API', " ")
    REPOSITORY = getenv("REPOSITORY", "https://github.com/Wolf2901/SilentRobot")
    ...
    BOT_NAME = getenv("BOT_NAME", "Silent") # Name Of your Bot.4
    BOT_USERNAME = getenv("BOT_USERNAME", "SilentRobot") # Bot Username
