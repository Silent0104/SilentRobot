...
import spamwatch
import aiohttp
from SilentRobot.services.quoteapi import Quotly
...
LOGGER = logging.getLogger("[SilentRobot]")
...
telethn = TelegramClient("Silent", API_ID, API_HASH)
pbot = Client("SilentRobotpbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from SilentRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
