...
def get_user_list(config, key):
    with open('{}/SilentRobot/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    OWNER_ID = 5278339583 # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "awoo"
    SUPPORT_CHAT = 'SilentSupport'  #Your own group for support, do not add the @
