...
import SilentRobot.modules.sql.notes_sql as sql
from SilentRobot import LOGGER, dispatcher, DRAGONS
from SilentRobot.modules.helper_funcs.chat_status import connection_status
from SilentRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from SilentRobot.modules.helper_funcs.msg_types import get_note_type
from SilentRobot.modules.helper_funcs.handlers import MessageHandlerChecker
from SilentRobot.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
...
from SilentRobot.modules.helper_funcs.decorators import Silentcmd, Silentmsg, Silentcallback
...
@Silentmsg((Filters.regex(r"^#[^\s]+")), group=-14)
@connection_status
...
@Silentmsg((Filters.regex(r"^/\d+$")), group=-16)
@connection_status
...
@Silentcmd(command='removeallnotes')
...
@Silentcallback(pattern=r"notes_.*")
