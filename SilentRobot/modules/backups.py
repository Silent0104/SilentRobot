...
from SilentRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from SilentRobot.__main__ import DATA_IMPORT
from SilentRobot.modules.helper_funcs.chat_status import user_admin
from SilentRobot.modules.helper_funcs.alternate import typing_action

# from NekoRobot.modules.rules import get_rules
import SilentRobot.modules.sql.rules_sql as rulessql

# from NekoRobot.modules.sql import warns_sql as warnssql
import SilentRobot.modules.sql.blacklist_sql as blacklistsql
from SilentRobot.modules.sql import disable_sql as disabledsql

# from NekoRobot.modules.sql import cust_filters_sql as filtersql
# import NekoRobot.modules.sql.welcome_sql as welcsql
import SilentRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    f = open("Silent {}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Silent {}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Silent -Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
