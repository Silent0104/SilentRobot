...
from SilentRobot.modules.helper_funcs.misc import article
from SilentRobot.modules.helper_funcs.decorators import Silentinline
...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Silent",
            "description": "SilentRobot Inline",
            "message_text": "Click the button below to get the Silent Inline.",
        ...
        {
            "title": "Account info on Silent",
            "description": "Look up a Telegram account in Silent database",
            "message_text": "Click the button below to look up a person in Silent database using their Telegram ID",
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\nThis Person is a part Developer of Silent"
        nation_level_present = True
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Report Error",
                    url=f"https://t.me/SilentSupport",
                ),
                InlineKeyboardButton(
                    text="Search again",
...
def silent(query: str, update: Update, context: CallbackContext) -> None:
    """Handle the inline query."""
    query = update.inline_query.query
    user_id = update.effective_user.id
    user = context.bot.get_chat(user_id)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Silent Robot",
                    url=f"https://t.me/Silent_Robo_Bot",
                ),
            ...
            [
                InlineKeyboardButton(
                 ...
                 InlineKeyboardButton(
                    text="Updates",
                    url=f"https://t.me/Galaxia_Update",
                ),
...
def help(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        InlineQueryResultPhoto(
            ...
            title="Help Commands",
            thumb_url="https://telegra.ph/file/0b5e88c90238c357641a7.jpg",
            photo_url="https://te.legra.ph/file/653cc589cef8ce310a9f2.jpg",
            caption=help_text,
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=kb,
        )
...
def kaizuryu(query: str, update: Update, context: CallbackContext) -> None:
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Silent Smile",
                    url=f"https://t.me/Silent_Smile_04",
                ),
            ...
            [
                InlineKeyboardButton(
                    text="Chat Group",
                    url=f"https://t.me/+KLFKTzIQ1HFmOTRl",
                ),
    ...
    results.append(
        InlineQueryResultPhoto(
            id=str(uuid4()),
            title="Silent Smile",
            description="Get Silent Smile id Link",
            thumb_url="https://telegra.ph/file/5daac1fcf88ca6f177ef4.jpg",
