...
import SilentRobot.modules.sql.welcome_sql as sql
from SilentRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, EVENT_LOGS, JOIN_LOGGER, pgram)
from SilentRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from SilentRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from SilentRobot.modules.helper_funcs.msg_types import get_welcome_type
from SilentRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from SilentRobot.modules.log_channel import loggable
from SilentRobot.modules.sql.global_bans_sql import is_user_gbanned
...
Silent_IMG = "https://telegra.ph/file/4f9d3cd448f3d319afca9.mp4"
Silent = "https://telegra.ph/file/6cbc8452a2796ad58c2f9.jpg"
Silent_VID = "https://telegra.ph/file/d7ffd1eae2984b0cfb148.jpg"
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                Silent_IMG, caption= "Behold!!! Owner Of @SilentRobot Joined Your Chat.",
                    reply_to_message_id=reply)
            ...
            # Welcome Sudos
                ...
                Silent, caption= "Huh! An Evangalion Pilot Joined Your Chat",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_photo(
                Silent, caption= "Huh! Someone with a Evangelion 3.0 level just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_photo(
                Silent, caption= "Oof! Evangelion 2.0 just joined!",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_photo(
                Silent, caption= "Oof! Evangelion 1.0 just joined!",
                    reply_to_message_id=reply)
                continue
            # Welcome yourself
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [                  
                       InlineKeyboardButton(
                             text="Support",
                             url=f"https://t.me/Silent_robo_11"),
                       InlineKeyboardButton(
                             text="Silent Smile ",
                             url="https://t.me/Silent_Smile_04")
                     ],
                     [                  
                       InlineKeyboardButton(
                             text="Help",
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_photo(
                Silent_VID, caption= "Alas! My Master Left...", reply_to_message_id=reply)
                return

            # Give the devs a special goodbye
            elif left_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "See you later at the @Silent_robo_11!",
                    reply_to_message_id=reply,
                )
                return
...
HELP_STRINGS = """
Hey [{}](tg://user?id={}) your *Silent* is here! 
