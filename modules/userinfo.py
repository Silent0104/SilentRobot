...
from SilentRobot.__main__ import STATS, TOKEN, USER_INFO
from SilentRobot.modules.sql import SESSION
import SilentRobot.modules.sql.userinfo_sql as sql
...
from SilentRobot.modules.redis.afk_redis import is_user_afk, afk_reason
from SilentRobot.modules.sql.users_sql import get_user_num_chats
from SilentRobot.modules.helper_funcs.chat_status import sudo_plus
from SilentRobot.modules.helper_funcs.extraction import extract_user
from SilentRobot import telethn

Silent_IMG = "https://te.legra.ph/file/653cc589cef8ce310a9f2.jpg"
...
def info(update: Update, context: CallbackContext):
    ...
    [
                        InlineKeyboardButton(
                             text="Health",
                             url="https://t.me/SilentUpdates/4"),
                       InlineKeyboardButton(
                             text="Disasters",
                             url="https://t.me/SilentUpdates/5"),
                    ],
    ]
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_photo(
            ...
            + f"\n\n[Support](https://t.me/{SUPPORT_CHAT}) | [Updates](https://t.me/SilentUpdates)\n\n"
