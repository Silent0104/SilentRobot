...
import html
import requests
import SilentRobot.modules.sql.chatbot_sql as sql
...
from SilentRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from SilentRobot import dispatcher, updater, SUPPORT_CHAT
from SilentRobot.modules.log_channel import gloggable
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Silent Chat Bot Disabled by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Silent Chat Bot Enabled By {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
