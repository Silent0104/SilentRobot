...
import SilentRobot.modules.sql.global_bans_sql as gban_sql
import SilentRobot.modules.sql.users_sql as user_sql
from SilentRobot import DEV_USERS, OWNER_ID, dispatcher
