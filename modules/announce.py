...
import SilentRobot.modules.sql.logger_sql as sql
from SilentRobot.modules.helper_funcs.anonymous import user_admin as u_admin, AdminPerms


@Silentcmd(command="announce", pass_args=True)
