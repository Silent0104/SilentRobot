...
from SilentRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from SilentRobot import EVENT_LOGS as GBAN_LOGS, LOGGER as log, dispatcher
    from SilentRobot.modules.helper_funcs.chat_status import user_admin as u_admin, is_user_admin
    from SilentRobot.modules.sql import log_channel_sql as sql
...
@Silentcallback(pattern=r"log_tog_.*")
