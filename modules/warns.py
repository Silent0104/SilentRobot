...
from SilentRobot import dispatcher  # BAN_STICKER
...
from SilentRobot.modules.helper_funcs.string_handling import split_quotes
from SilentRobot.modules.log_channel import loggable
from SilentRobot.modules.sql import warns_sql as sql
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "Rules", url="http://t.me/Silent_Smile_04?start={}".format(chat.id)
                    )
                ]
            ]
        )
